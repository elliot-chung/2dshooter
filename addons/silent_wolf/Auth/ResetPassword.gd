...
func _ready():
	...
	SilentWolf.Auth.connect("sw_request_password_reset_succeeded",Callable(self,"_on_send_code_succeeded"))
	SilentWolf.Auth.connect("sw_request_password_reset_failed",Callable(self,"_on_send_code_failed"))
	SilentWolf.Auth.connect("sw_reset_password_succeeded",Callable(self,"_on_reset_succeeded"))
	SilentWolf.Auth.connect("sw_reset_password_failed",Callable(self,"_on_reset_failed"))
